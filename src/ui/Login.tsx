//以下URLのソースを取得して改変したものです。
//https://github.com/mui/material-ui/tree/v5.11.9/docs/data/material/getting-started/templates/sign-in
...
function Copyright(props: any) {
  return (
    <Typography variant="body2" color="text.secondary" align="center" {...props}>
      {'Copyright © '}
      <Link color="inherit" href="https://www.rna.co.jp/" target={'_blank'}>
        Sampoh Inc.
      </Link>{' '}
...
export default function Login() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    mySession.login({
        account:data.get('username') as string,
